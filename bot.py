...
TR = {
    "ru": {
        ...
        "about_text2": "💈 Мастер: Баходир — опыт работы более 5 лет.\nЗнает всё о мужских стрижках, бороде и стиле.",
        ...
        "about_w3": "✦ Уютная атмосфера и бесплатный кофе ☕",
        ...
        "about_outro": "У нас вы можете отдохнуть, выпить чашечку кофе и выйти с новой уверенностью. ✂",
    ...
    "uz": {
        ...
        "about_outro": "Bizda dam olishingiz, bir piyola kofe ichishingiz va yangi ishonch bilan chiqishingiz mumkin. ✂",
    ...
    "kz": {
        ...
        "about_outro": "Бізде демалуға, бір кесе кофе ішуге және жаңа сенімділікпен шығуға болады. ✂",
    ...
    "kg": {
        ...
        "about_outro": "Бизде эс алып, бир чыны кофе ичип, жаңы ишеним менен чыга аласыз. ✂",
    ...
    "tj": {
        ...
        "about_outro": "Дар назди мо шумо метавонед истироҳат кунед, як пиёла қаҳва нӯшед ва бо боварии нав бароед. ✂",
